...
source_directory_img_path = 'E:\\datasets\\DA_data\\tomato_val\\images'
source_directory_label_path = 'E:\\datasets\\DA_data\\tomato_val\\labels'
target_directory_path = 'E:\\PythonProject\\Tools\\new'
dic = {}
...
def draw_label(image_path, label_path):
    ...
    for _, x in enumerate(lb):
        ...
        # 绘图
        cv2.rectangle(img, (int(x[1]), int(x[2])), (int(x[3]), int(x[4])), (0, 255, 0),6)
